      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="relative group">
            ...
            <div
              class="absolute right-0 w-48 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300"
            >
              <!-- Menu Background -->
              <div
                class="bg-gray-800 rounded-md shadow-xl ring-1 ring-black ring-opacity-5"
              >
                <!-- Menu Items -->
                <div class="py-1">
                  <div class="py-1">
          ...
          <a
            ...
            class="flex items-center px-4 py-2 hover:bg-gray-700 rounded text-center"
            >Contact Me</a
          >
        </div>
      </div>
